	...
	<xsl:template match="doc" mode="query">
		<Placemark id="{str[@name='recordId']}">
			...
			<description>
				...
				<![CDATA[
				<ul style="list-style-type:none"><li><b>Object Type: </b>]]>
				<xsl:value-of select="arr[@name='objectType_facet']/str"/>
				<![CDATA[</li>				
				]]>
				<xsl:if test="arr[@name='department_facet']">
					<![CDATA[
					<li><b>Department: </b>]]>
					<xsl:value-of select="arr[@name='department_facet']/str"/>
					<![CDATA[</li>]]>
				</xsl:if>
				...
				<xsl:if test="arr[@name='findspot_facet']/str">
					<![CDATA[
					<li><b>Findspot: </b>]]>
					<xsl:value-of select="arr[@name='findspot_facet']/str"/>
					<![CDATA[</li>]]>
				</xsl:if>
				...
				<![CDATA[</ul>
				<![CDATA[<a href="]]>
				<xsl:value-of select="arr[@name='mint_uri']/str"/>
				<![CDATA[">View Mint</a><br/>]]>
				<![CDATA[<a href="]]>
